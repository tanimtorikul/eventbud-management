    ...
    <>
      <div className="hero px-4 md:px-0 my-12">
        ...
        <div className="card w-full md:w-[752px] py-12 shadow-2xl bg-base-100">
          <form onSubmit={handleLogin} className="card-body w-full md:w-[560px] mx-auto">
          <h2 className="text-4xl text-center font-semibold mb-[50px]">Login your account</h2>
          <p className="border border-[#E7E7E7] mb-[50px]"></p>
            ...
            <h2 className="text-center text-lg font-medium">Don't Have An Account? <Link to='/register'><span className="text-red-400">Register</span></Link> </h2>
          </form>
